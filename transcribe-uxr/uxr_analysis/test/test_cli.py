...
import sys
sys.path.append('..')
from uxr_analysis.cli import main as cli

class TestMainFunction(unittest.TestCase):

    @patch('uxr_analysis.cli.ConfigManager')
    @patch('uxr_analysis.cli.Uploader')
    @patch('uxr_analysis.cli.TranscriptionJobMonitor')
    @patch('uxr_analysis.cli.Processor')
    @patch('uxr_analysis.cli.Summarizer')
    @patch('uxr_analysis.cli.Scorer')
    ...
    @patch('uxr_analysis.cli.ConfigManager.get_latest_output_dir')
    @patch('uxr_analysis.cli.ConfigManager.confirm_latest_output_dir', return_value=True)
    @patch('uxr_analysis.cli.Uploader')
