...
class TestMainFunction(unittest.TestCase):
    ...
    @patch("src.cli.Uploader")
    @patch(
        "builtins.input", side_effect=["1", "test_directory", "6"]
    )  # Simulates choosing option 1 then quitting
    ...
    )  # Simulates choosing option 2 then quitting
    def test_main_check_transcription(
        self, mock_input, mock_monitor, mock_confirm, mock_get_dir
    ):
        mock_get_dir.return_value = "test_output_dir"
        cli()
    ...
    @patch("src.cli.Processor")
    @patch(
        "builtins.input", side_effect=["3", "6"]
    )  # Simulates choosing option 3 then quitting
    def test_main_process_transcripts(
        self, mock_input, mock_processor, mock_confirm, mock_get_dir
    ):
        mock_get_dir.return_value = "test_output_dir"
        cli()
    ...
    @patch("src.cli.Summarizer")
    @patch(
        "builtins.input", side_effect=["4", "6"]
    )  # Simulates choosing option 4 then quitting
    def test_main_summarize_transcripts(
        self, mock_input, mock_summarizer, mock_confirm, mock_get_dir
    ):
        mock_get_dir.return_value = "test_output_dir"
        cli()
    ...
    @patch("src.cli.Scorer")
    @patch(
        "builtins.input", side_effect=["5", "6"]
    )  # Simulates choosing option 5 then quitting
    def test_main_score_transcripts(
        self, mock_input, mock_scorer, mock_confirm, mock_get_dir
    ):
        mock_get_dir.return_value = "test_output_dir"
        cli()
